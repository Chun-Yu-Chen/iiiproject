...
//		conn = DriverManager.getConnection(connUrl, "sa", "passw0rd");
	...
	public int insertfolkfestival(ActivityVO act) throws SQLException {
		...
		pstmt.setNString(1, act.getActivityid());
		pstmt.setNString(2, act.getActivityname());
		pstmt.setNString(3, act.getActivityregion());
		pstmt.setNString(4, act.getActivitytype());
		...
		pstmt.setNString(18, act.getActivityaddress());
		pstmt.setNString(19, act.getActivitytel());
		pstmt.setNString(20, act.getActivityintro());
		pstmt.setNull(21,java.sql.Types.INTEGER);
		pstmt.setNull(22,java.sql.Types.FLOAT);
		pstmt.setNull(23,java.sql.Types.FLOAT);
	...
	public int insertneighbor(ActivityNeighborVO nei) throws SQLException {
		...
		pstmt1.setNString(1, nei.getActivityid());
